...
const HeroSection = () => {
  ...
  const [initialView, setInitialView] = useState<"login" | "getStarted">(
    "login"
  );

  return (
    <div className="min-h-[638px] h-screen mob:h-full bg-accent px-5 flex items-center relative mob:mt-0 mt-[-130px]">
      <div className="w-full flex flex-wrap gap-16 max-w-[1313px] mx-auto mob:mt-[150px]">
        <div className="max-w-[423px] relative z-10">
          ...
          <Text className="text-white text-[28px] font-light ">
            Master Crypto Shape Your Future!
          </Text>
          <Text className="text-white text-[16px] font-light mt-5 mb-6">
            Unleash your trading potential with the best lessons, courses and
            quizzes from AvaAcademy.
          </Text>
        ...
        <Image
          className=" h-full object-cover w-auto absolute top-0 right-0  z-0 mob:relative mob:max-w-full mob:w-full "
          src={herobg}
          alt="herobg"
        />
      </div>
