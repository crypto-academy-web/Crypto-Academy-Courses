    ...
    <div className="mt-20 mb-10 px-5">
      <div className="w-full max-w-[1313px] mx-auto bg-[#20263040] py-8 rounded-[30px] mob:px-5">
        ...
        <Text className="text-center text-[17px] font-normal leading-[131%] max-w-[648px] mx-auto mt-2">
          “I knew the basics of trading, but I didn’t understand the important
          of things like technical analysis, Stop-Loss and Take Profit orders.
          AvaAcademy, you have given me the gift of knowledge. Much appreciated”
        </Text>
