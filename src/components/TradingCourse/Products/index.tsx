...
const Products = () => {
    ...
    const handleCourseClick = (course: Course) => {
        ...
        router.push(isPurchased || course.type === 'free' ? '/start-trading-course' : '/checkout');
    };
        ...
        <div className='w-full px-5'>
            <div className="max-w-[1313px] mx-auto w-full">
                <div className="flex justify-between">
                    <Text as='h1' className='text-black text-[36px] mob:hidden'>Trading Courses</Text>
                    ...
                    <div className="flex items-center">
                        <button className="bg-primary w-[65px] h-[28px] flex items-center justify-center text-[9px] font-helvetica font-medium text-white">Sort By</button>
                        <select className="flex-grow focus:outline-none font-helvetica text-[8px] text-primary border border-[#00000066] px-3 py-2 w-full max-w-[155px] h-[28px] bg-white">
                ...
                <Text as='h1' className='text-black text-[36px] mob:block hidden mt-8'>Trading Courses</Text>

                <Text className='text-[14px] font-helvetica font-normal leading-[133%] max-w-[1187px] my-8 mob:my-4'>
                    Unlock your trading potential with AvaAcademy! Register for free and gain exclusive access to advanced courses on trading platforms...
                </Text>
                                    ...
                                    >
                                        ...
                                        <div className="px-[23px] py-[16px]">
                                            ...
                                            <div className="flex justify-between items-center mt-1">
                                                ...
                                                <Text className="text-[12px] font-bold">{displayPrice}</Text>
                                            </div>
                                        </div>
                                    </div>
                                );
