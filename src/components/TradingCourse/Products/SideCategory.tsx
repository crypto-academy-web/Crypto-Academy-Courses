...
// const LevelsOptions = ["Beginner", "Intermediate", "Advanced"];
  ...
  return (
    <>
      <div className="w-full max-w-[251px] course-shadow pb-6">
        {/* Category */}
        <div className="w-full max-w-[251px] border-t-[4px] border-accent  px-4 pt-8 pb-5">
          ...
          {CategoryOptions.map((option, index) => (
            <div key={index} className="flex items-center mb-4">
              ...
              <label
                ...
                className="ml-2 text-[12px] text-black font-helvetica font-normal"
              >
                {option}
              </label>
            </div>
        ...
        <Button className="max-w-[156px] h-[38px] rounded-[4px] bg-accent text-[12px] font-medium mx-auto">
          Show Results
        </Button>

        <Button className="text-black mx-auto text-[12px] font-normal mt-2">
          Reset all
        </Button>
      </div>
    </>
