      ...
      <div className="w-full max-w-[1313px] mx-auto flex tab:flex-wrap gap-10 mob:gap-5 justify-between">
        ...
        <div className="w-full max-w-[792px] px-4 py-7  border-[0.5px] border-black rounded-[20px] my-12">
          <div className="flex gap-10">
            <button className="text-[14px] font-bold leading-[100%]">
              Description
            </button>
            <button className="text-[14px] font-bold leading-[100%]">
              Curriculum
          ...
          <Text className="text-[16px] font-normal leading-[133%] max-w-[728px] mb-5">
            For those of us who have a basic understanding of finance but have
            never traded, it may be sufficient to learn the fundamentals of
            financial markets. This course provides a short recap of our
            extended courses, enabling us to tie together what we know with what
            is required. We will learn what financial markets are, what Forex is
            and how to trade it with relative ease and safety.
          </Text>

          <Text as="h2" className="text-[21px] leading-[20px] ">
            What We Will Learn:
            <ul className="mt-3 list-disc pl-5 text-[16px] font-normal leading-[144%]">
              <li>
                <span className="font-bold">Fundamental Ties:</span> Link your
                financial understanding to trading essentials, seamlessly.
              </li>
              <li>
                <span className="font-bold">Forex Unveiled:</span> Demystify
                foreign exchange markets and learn safe, accessible trading
                techniques.
              </li>
              <li>
                <span className="font-bold">Smart Instrument Use:</span> Grasp
                the convenience of Contracts for Difference (CFDs) in financial
                markets.
              </li>
              <li>
                <span className="font-bold">Market Mastery:</span> Dive into
                market orders for strategic investment decisions.
              </li>
              <li>
                <span className="font-bold">Analytical Insights:</span> Extract
                valuable insights from financial analysis.
              </li>
            </ul>
          </Text>
          ...
          <Text as="h2" className="text-[21px] leading-[20px] mt-8 ">
            ...
            <ul className="mt-3 list-disc pl-5 text-[16px] font-normal leading-[144%]">
              <li>
                ...
                <span className="text-[#7B6FFE] italic underline">
                  {" "}
                  log into your trading account{" "}
                </span>{" "}
                at AvaTrade for practice purposes
              </li>
              <li>
                Some lessons might appear in multiple courses due to their
                relevance
              </li>
            </ul>
          </Text>

          <Button className="bg-accent max-w-[351px] mx-auto h-[50px] rounded-[7px] my-10">
            {" "}
          ...
          <div className="w-full  flex flex-wrap items-center mob:justify-center gap-3">
            {courses.map((course, index) => (
              <div
                key={index}
                className="max-w-[244px] rounded-[20px] course-shadow relative"
              >
                ...
                <div className="px-[23px] py-[16px]">
                  <Text className="text-[#0000004D] text-[10px] font-light">
                    {course.title}
                  </Text>
        ...
        <div className="w-full max-w-[401px] mt-[-250px] xl:mt-[50px] tab:mt-[0px] tab:mb-[40px]">
          <div className="w-full max-w-[401px] px-4 py-5 bg-white border-[0.5px] border-black rounded-[20px]">
            <Image
              className="w-full max-h-[183px] object-cover rounded-[10px]"
              src={course1}
              alt="course1"
            />
            ...
            {/* <div className="flex justify-center gap-5 mt-5">
              <div className="flex gap-1 items-center">
                <Image
                  ...
                  height={12}
                />
                <Text className="text-[8px] text-[#00000080] leading-[100%]">
                  Add to Wishlist
                </Text>
              </div>
              <div className="flex gap-1 items-center">
            ...
            <Text className="text-[11px] text-[#00000080] font-bold  my-6">
              30-Day Money-Back Guarantee
            </Text>

            <Text className="text-[11px] text-[#00000080] font-bold">
              Course Details
            </Text>
            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-1 items-center">
                <Image
                  ...
                  height={12}
                />
                <Text className="text-[10px] text-[#000000] leading-[100%] ">
                  Duration
                </Text>
              </div>
              <Text className="text-[10px]  leading-[100%] font-bold">
                80 minutes
              </Text>
            </div>
